...
- **run-walk-metronome-v3/** - smooth-rhythm run/walk metronome with Web Audio clock scheduling, separate run and walk BPM, presets, session timeline, and installable offline assets.
...
### `plans/`
- **todays-workout.html** – public entry point for the current coaching workout, with exercise guidance, local logging, rest timers and recap export.
